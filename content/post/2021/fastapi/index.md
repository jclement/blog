...
On a new VM with Docker and `docker-compose` deployed, let's configure this to work for real (I'm using the domain `demo.straybits.org` for this...)
...
straybits.org {
        redir https://www.straybits.org{uri}
}
```
